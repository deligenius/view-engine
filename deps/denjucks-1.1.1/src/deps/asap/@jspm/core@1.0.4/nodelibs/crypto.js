...
function dew$4() {
  ...
  function Hash(blockSize, finalSize) {
    (this || _global$1)._block = Buffer.alloc(blockSize);
    (this || _global$1)._finalSize = finalSize;
    (this || _global$1)._blockSize = blockSize;
    (this || _global$1)._len = 0;
  }
  ...
  Hash.prototype.update = function (data, enc) {
    ...
    var block = (this || _global$1)._block;
    var blockSize = (this || _global$1)._blockSize;
    var length = data.length;
    var accum = (this || _global$1)._len;
    ...
    (this || _global$1)._len += length;
    return this || _global$1;
  };

  Hash.prototype.digest = function (enc) {
    var rem = (this || _global$1)._len % (this || _global$1)._blockSize;
    (this || _global$1)._block[rem] = 0x80; // zero (rem + 1) trailing bits, where (rem + 1) is the smallest
    // non-negative solution to the equation (length + 1 + (rem + 1)) === finalSize mod blockSize

    (this || _global$1)._block.fill(0, rem + 1);

    if (rem >= (this || _global$1)._finalSize) {
      this._update((this || _global$1)._block);

      (this || _global$1)._block.fill(0);
    }

    var bits = (this || _global$1)._len * 8; // uint32

    if (bits <= 0xffffffff) {
      (this || _global$1)._block.writeUInt32BE(bits, (this || _global$1)._blockSize - 4); // uint64

    } else {
      var lowBits = (bits & 0xffffffff) >>> 0;
      var highBits = (bits - lowBits) / 0x100000000;

      (this || _global$1)._block.writeUInt32BE(highBits, (this || _global$1)._blockSize - 8);

      (this || _global$1)._block.writeUInt32BE(lowBits, (this || _global$1)._blockSize - 4);
    }
...
function dew$5() {
  ...
  function Sha() {
    this.init();
    (this || _global$2)._w = W;
    Hash.call(this || _global$2, 64, 56);
  }

  inherits(Sha, Hash);

  Sha.prototype.init = function () {
    (this || _global$2)._a = 0x67452301;
    (this || _global$2)._b = 0xefcdab89;
    (this || _global$2)._c = 0x98badcfe;
    (this || _global$2)._d = 0x10325476;
    (this || _global$2)._e = 0xc3d2e1f0;
  ...
  Sha.prototype._update = function (M) {
    var W = (this || _global$2)._w;
    var a = (this || _global$2)._a | 0;
    var b = (this || _global$2)._b | 0;
    var c = (this || _global$2)._c | 0;
    var d = (this || _global$2)._d | 0;
    var e = (this || _global$2)._e | 0;
    ...
    (this || _global$2)._a = a + (this || _global$2)._a | 0;
    (this || _global$2)._b = b + (this || _global$2)._b | 0;
    (this || _global$2)._c = c + (this || _global$2)._c | 0;
    (this || _global$2)._d = d + (this || _global$2)._d | 0;
    (this || _global$2)._e = e + (this || _global$2)._e | 0;
  };

  Sha.prototype._hash = function () {
    var H = Buffer.allocUnsafe(20);
    H.writeInt32BE((this || _global$2)._a | 0, 0);
    H.writeInt32BE((this || _global$2)._b | 0, 4);
    H.writeInt32BE((this || _global$2)._c | 0, 8);
    H.writeInt32BE((this || _global$2)._d | 0, 12);
    H.writeInt32BE((this || _global$2)._e | 0, 16);
    return H;
  };
...
function dew$6() {
  ...
  function Sha1() {
    this.init();
    (this || _global$3)._w = W;
    Hash.call(this || _global$3, 64, 56);
  }

  inherits(Sha1, Hash);

  Sha1.prototype.init = function () {
    (this || _global$3)._a = 0x67452301;
    (this || _global$3)._b = 0xefcdab89;
    (this || _global$3)._c = 0x98badcfe;
    (this || _global$3)._d = 0x10325476;
    (this || _global$3)._e = 0xc3d2e1f0;
  ...
  Sha1.prototype._update = function (M) {
    var W = (this || _global$3)._w;
    var a = (this || _global$3)._a | 0;
    var b = (this || _global$3)._b | 0;
    var c = (this || _global$3)._c | 0;
    var d = (this || _global$3)._d | 0;
    var e = (this || _global$3)._e | 0;
    ...
    (this || _global$3)._a = a + (this || _global$3)._a | 0;
    (this || _global$3)._b = b + (this || _global$3)._b | 0;
    (this || _global$3)._c = c + (this || _global$3)._c | 0;
    (this || _global$3)._d = d + (this || _global$3)._d | 0;
    (this || _global$3)._e = e + (this || _global$3)._e | 0;
  };

  Sha1.prototype._hash = function () {
    var H = Buffer.allocUnsafe(20);
    H.writeInt32BE((this || _global$3)._a | 0, 0);
    H.writeInt32BE((this || _global$3)._b | 0, 4);
    H.writeInt32BE((this || _global$3)._c | 0, 8);
    H.writeInt32BE((this || _global$3)._d | 0, 12);
    H.writeInt32BE((this || _global$3)._e | 0, 16);
    return H;
  };
...
function dew$7() {
  ...
  function Sha256() {
    this.init();
    (this || _global$4)._w = W; // new Array(64)

    Hash.call(this || _global$4, 64, 56);
  }

  inherits(Sha256, Hash);

  Sha256.prototype.init = function () {
    (this || _global$4)._a = 0x6a09e667;
    (this || _global$4)._b = 0xbb67ae85;
    (this || _global$4)._c = 0x3c6ef372;
    (this || _global$4)._d = 0xa54ff53a;
    (this || _global$4)._e = 0x510e527f;
    (this || _global$4)._f = 0x9b05688c;
    (this || _global$4)._g = 0x1f83d9ab;
    (this || _global$4)._h = 0x5be0cd19;
  ...
  Sha256.prototype._update = function (M) {
    var W = (this || _global$4)._w;
    var a = (this || _global$4)._a | 0;
    var b = (this || _global$4)._b | 0;
    var c = (this || _global$4)._c | 0;
    var d = (this || _global$4)._d | 0;
    var e = (this || _global$4)._e | 0;
    var f = (this || _global$4)._f | 0;
    var g = (this || _global$4)._g | 0;
    var h = (this || _global$4)._h | 0;
    ...
    (this || _global$4)._a = a + (this || _global$4)._a | 0;
    (this || _global$4)._b = b + (this || _global$4)._b | 0;
    (this || _global$4)._c = c + (this || _global$4)._c | 0;
    (this || _global$4)._d = d + (this || _global$4)._d | 0;
    (this || _global$4)._e = e + (this || _global$4)._e | 0;
    (this || _global$4)._f = f + (this || _global$4)._f | 0;
    (this || _global$4)._g = g + (this || _global$4)._g | 0;
    (this || _global$4)._h = h + (this || _global$4)._h | 0;
  };

  Sha256.prototype._hash = function () {
    var H = Buffer.allocUnsafe(32);
    H.writeInt32BE((this || _global$4)._a, 0);
    H.writeInt32BE((this || _global$4)._b, 4);
    H.writeInt32BE((this || _global$4)._c, 8);
    H.writeInt32BE((this || _global$4)._d, 12);
    H.writeInt32BE((this || _global$4)._e, 16);
    H.writeInt32BE((this || _global$4)._f, 20);
    H.writeInt32BE((this || _global$4)._g, 24);
    H.writeInt32BE((this || _global$4)._h, 28);
    return H;
  };
...
function dew$8() {
  ...
  function Sha224() {
    this.init();
    (this || _global$5)._w = W; // new Array(64)

    Hash.call(this || _global$5, 64, 56);
  }

  inherits(Sha224, Sha256);

  Sha224.prototype.init = function () {
    (this || _global$5)._a = 0xc1059ed8;
    (this || _global$5)._b = 0x367cd507;
    (this || _global$5)._c = 0x3070dd17;
    (this || _global$5)._d = 0xf70e5939;
    (this || _global$5)._e = 0xffc00b31;
    (this || _global$5)._f = 0x68581511;
    (this || _global$5)._g = 0x64f98fa7;
    (this || _global$5)._h = 0xbefa4fa4;
    return this || _global$5;
  };

  Sha224.prototype._hash = function () {
    var H = Buffer.allocUnsafe(28);
    H.writeInt32BE((this || _global$5)._a, 0);
    H.writeInt32BE((this || _global$5)._b, 4);
    H.writeInt32BE((this || _global$5)._c, 8);
    H.writeInt32BE((this || _global$5)._d, 12);
    H.writeInt32BE((this || _global$5)._e, 16);
    H.writeInt32BE((this || _global$5)._f, 20);
    H.writeInt32BE((this || _global$5)._g, 24);
    return H;
  };
...
function dew$9() {
  ...
  function Sha512() {
    this.init();
    (this || _global$6)._w = W;
    Hash.call(this || _global$6, 128, 112);
  }

  inherits(Sha512, Hash);

  Sha512.prototype.init = function () {
    (this || _global$6)._ah = 0x6a09e667;
    (this || _global$6)._bh = 0xbb67ae85;
    (this || _global$6)._ch = 0x3c6ef372;
    (this || _global$6)._dh = 0xa54ff53a;
    (this || _global$6)._eh = 0x510e527f;
    (this || _global$6)._fh = 0x9b05688c;
    (this || _global$6)._gh = 0x1f83d9ab;
    (this || _global$6)._hh = 0x5be0cd19;
    (this || _global$6)._al = 0xf3bcc908;
    (this || _global$6)._bl = 0x84caa73b;
    (this || _global$6)._cl = 0xfe94f82b;
    (this || _global$6)._dl = 0x5f1d36f1;
    (this || _global$6)._el = 0xade682d1;
    (this || _global$6)._fl = 0x2b3e6c1f;
    (this || _global$6)._gl = 0xfb41bd6b;
    (this || _global$6)._hl = 0x137e2179;
  ...
  Sha512.prototype._update = function (M) {
    var W = (this || _global$6)._w;
    var ah = (this || _global$6)._ah | 0;
    var bh = (this || _global$6)._bh | 0;
    var ch = (this || _global$6)._ch | 0;
    var dh = (this || _global$6)._dh | 0;
    var eh = (this || _global$6)._eh | 0;
    var fh = (this || _global$6)._fh | 0;
    var gh = (this || _global$6)._gh | 0;
    var hh = (this || _global$6)._hh | 0;
    var al = (this || _global$6)._al | 0;
    var bl = (this || _global$6)._bl | 0;
    var cl = (this || _global$6)._cl | 0;
    var dl = (this || _global$6)._dl | 0;
    var el = (this || _global$6)._el | 0;
    var fl = (this || _global$6)._fl | 0;
    var gl = (this || _global$6)._gl | 0;
    var hl = (this || _global$6)._hl | 0;
    ...
    (this || _global$6)._al = (this || _global$6)._al + al | 0;
    (this || _global$6)._bl = (this || _global$6)._bl + bl | 0;
    (this || _global$6)._cl = (this || _global$6)._cl + cl | 0;
    (this || _global$6)._dl = (this || _global$6)._dl + dl | 0;
    (this || _global$6)._el = (this || _global$6)._el + el | 0;
    (this || _global$6)._fl = (this || _global$6)._fl + fl | 0;
    (this || _global$6)._gl = (this || _global$6)._gl + gl | 0;
    (this || _global$6)._hl = (this || _global$6)._hl + hl | 0;
    (this || _global$6)._ah = (this || _global$6)._ah + ah + getCarry((this || _global$6)._al, al) | 0;
    (this || _global$6)._bh = (this || _global$6)._bh + bh + getCarry((this || _global$6)._bl, bl) | 0;
    (this || _global$6)._ch = (this || _global$6)._ch + ch + getCarry((this || _global$6)._cl, cl) | 0;
    (this || _global$6)._dh = (this || _global$6)._dh + dh + getCarry((this || _global$6)._dl, dl) | 0;
    (this || _global$6)._eh = (this || _global$6)._eh + eh + getCarry((this || _global$6)._el, el) | 0;
    (this || _global$6)._fh = (this || _global$6)._fh + fh + getCarry((this || _global$6)._fl, fl) | 0;
    (this || _global$6)._gh = (this || _global$6)._gh + gh + getCarry((this || _global$6)._gl, gl) | 0;
    (this || _global$6)._hh = (this || _global$6)._hh + hh + getCarry((this || _global$6)._hl, hl) | 0;
  };
  ...
  Sha512.prototype._hash = function () {
    ...
    writeInt64BE((this || _global$6)._ah, (this || _global$6)._al, 0);
    writeInt64BE((this || _global$6)._bh, (this || _global$6)._bl, 8);
    writeInt64BE((this || _global$6)._ch, (this || _global$6)._cl, 16);
    writeInt64BE((this || _global$6)._dh, (this || _global$6)._dl, 24);
    writeInt64BE((this || _global$6)._eh, (this || _global$6)._el, 32);
    writeInt64BE((this || _global$6)._fh, (this || _global$6)._fl, 40);
    writeInt64BE((this || _global$6)._gh, (this || _global$6)._gl, 48);
    writeInt64BE((this || _global$6)._hh, (this || _global$6)._hl, 56);
    return H;
  };
...
function dew$a() {
  ...
  function Sha384() {
    this.init();
    (this || _global$7)._w = W;
    Hash.call(this || _global$7, 128, 112);
  }

  inherits(Sha384, SHA512);

  Sha384.prototype.init = function () {
    (this || _global$7)._ah = 0xcbbb9d5d;
    (this || _global$7)._bh = 0x629a292a;
    (this || _global$7)._ch = 0x9159015a;
    (this || _global$7)._dh = 0x152fecd8;
    (this || _global$7)._eh = 0x67332667;
    (this || _global$7)._fh = 0x8eb44a87;
    (this || _global$7)._gh = 0xdb0c2e0d;
    (this || _global$7)._hh = 0x47b5481d;
    (this || _global$7)._al = 0xc1059ed8;
    (this || _global$7)._bl = 0x367cd507;
    (this || _global$7)._cl = 0x3070dd17;
    (this || _global$7)._dl = 0xf70e5939;
    (this || _global$7)._el = 0xffc00b31;
    (this || _global$7)._fl = 0x68581511;
    (this || _global$7)._gl = 0x64f98fa7;
    (this || _global$7)._hl = 0xbefa4fa4;
  ...
  Sha384.prototype._hash = function () {
    ...
    writeInt64BE((this || _global$7)._ah, (this || _global$7)._al, 0);
    writeInt64BE((this || _global$7)._bh, (this || _global$7)._bl, 8);
    writeInt64BE((this || _global$7)._ch, (this || _global$7)._cl, 16);
    writeInt64BE((this || _global$7)._dh, (this || _global$7)._dl, 24);
    writeInt64BE((this || _global$7)._eh, (this || _global$7)._el, 32);
    writeInt64BE((this || _global$7)._fh, (this || _global$7)._fl, 40);
    return H;
  };
...
function dew$c() {
  ...
  function CipherBase(hashMode) {
    ...
    (this || _global$8).hashMode = typeof hashMode === 'string';

    if ((this || _global$8).hashMode) {
      (this || _global$8)[hashMode] = (this || _global$8)._finalOrDigest;
    } else {
      (this || _global$8).final = (this || _global$8)._finalOrDigest;
    }

    if ((this || _global$8)._final) {
      (this || _global$8).__final = (this || _global$8)._final;
      (this || _global$8)._final = null;
    }

    (this || _global$8)._decoder = null;
    (this || _global$8)._encoding = null;
  }
  ...
  CipherBase.prototype.update = function (data, inputEnc, outputEnc) {
    ...
    if ((this || _global$8).hashMode) return this || _global$8;
  ...
  CipherBase.prototype._toString = function (value, enc, fin) {
    if (!(this || _global$8)._decoder) {
      (this || _global$8)._decoder = new StringDecoder(enc);
      (this || _global$8)._encoding = enc;
    }

    if ((this || _global$8)._encoding !== enc) throw new Error('can\'t switch encodings');

    var out = (this || _global$8)._decoder.write(value);

    if (fin) {
      out += (this || _global$8)._decoder.end();
    }
