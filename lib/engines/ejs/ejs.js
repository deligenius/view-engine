...
// export const fileLoader = fs.readFileSync;
 ...
 * @return {String}
 */
export const resolveInclude = function (name, filename, isDir) {
...
function handleCache(options, template) {
  ...
  if (options.cache) {
    ...
    if (!hasTemplate) {
      template = fileLoader(filename).replace(_BOM, "");
    }
  } else if (!hasTemplate) {
...
// }
const fileLoader = Deno.readTextFileSync;
...
export const compile = function compile(template, opts) {
  var templ;
...
export const renderFile = function () {
